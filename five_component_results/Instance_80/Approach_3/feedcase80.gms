...
$onecho > baron.o80
SumName   "feedcase80bar.lst"
$offecho

qp.OptFile = 80;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 9.800633951345; mvd.up = 14.700950927017; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase80_sol', x, y, mvd, returnStat, lower_bnd 
