...
nl10..  
    +(6.250000*x('c423')/(6.250000-x('c561'))) 
...
nl11..  
    +(6.250000*x('c423')/(6.250000-x('c562'))) 
...
nl31..  
    +(6.250000*x('c419')/(6.250000-x('c561'))) 
...
nl33..  
    +(6.250000*x('c419')/(6.250000-x('c562'))) 
...
Execute_unload 'Feedcase377_2_sol', x, mvd, returnStat 
