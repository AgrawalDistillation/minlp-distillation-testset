...
$onecho > baron.377
SumName   "feedcase377bar.lst"
$offecho

qp.OptFile = 377;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 9.901568291007; mvd.up = 14.852352436510; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase377_sol', x, y, mvd, returnStat, lower_bnd 
