...
$onecho > baron.317
SumName   "feedcase317bar.lst"
$offecho

qp.OptFile = 317;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 12.941260289350; mvd.up = 19.411890434025; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase317_sol', x, y, mvd, returnStat, lower_bnd 
