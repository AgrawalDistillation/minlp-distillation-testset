...
$onecho > baron.378
SumName   "feedcase378bar.lst"
$offecho

qp.OptFile = 378;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 10.169011455642; mvd.up = 15.253517183463; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase378_sol', x, y, mvd, returnStat, lower_bnd 
