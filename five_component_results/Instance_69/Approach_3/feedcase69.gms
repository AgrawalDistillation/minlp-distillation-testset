...
$onecho > baron.o69
SumName   "feedcase69bar.lst"
$offecho

qp.OptFile = 69;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 12.923009327026; mvd.up = 19.384513990540; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase69_sol', x, y, mvd, returnStat, lower_bnd 
