...
$onecho > baron.o81
SumName   "feedcase81bar.lst"
$offecho

qp.OptFile = 81;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 7.538028530425; mvd.up = 11.307042795637; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase81_sol', x, y, mvd, returnStat, lower_bnd 
