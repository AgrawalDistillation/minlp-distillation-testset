...
nl2..  
    ...
    +(1.210000*x('c224')/(1.210000-x('c177'))) 
    -x('c285') =e= 0; 
...
nl3..  
    ...
    +(1.210000*x('c224')/(1.210000-x('c178'))) 
    -x('c285') =e= 0; 
...
nl4..  
    ...
    +(1.210000*x('c227')/(1.210000-x('c179'))) 
...
nl5..  
    ...
    +(1.210000*x('c227')/(1.210000-x('c180'))) 
...
nl6..  
    ...
    +(1.210000*x('c227')/(1.210000-x('c181'))) 
...
nl7..  
    ...
    +(1.210000*x('c242')/(1.210000-x('c189'))) 
...
nl8..  
    ...
    +(1.210000*x('c242')/(1.210000-x('c190'))) 
...
nl9..  
    ...
    +(1.210000*x('c242')/(1.210000-x('c191'))) 
...
nl10..  
    +(1.210000*x('c247')/(1.210000-x('c193'))) 
...
nl11..  
    +(1.210000*x('c247')/(1.210000-x('c194'))) 
...
nl13..  
    ...
    +(1.210000*x('c230')/(1.210000-x('c186'))) 
    +(1.210000*x('c237')/(1.210000-x('c186'))) 
    -x('c287') +x('c290') =e= 0; 
...
nl14..  
    ...
    +(1.210000*x('c232')/(1.210000-x('c187'))) 
    +(1.210000*x('c239')/(1.210000-x('c187'))) 
...
nl15..  
    ...
    +(1.210000*x('c232')/(1.210000-x('c188'))) 
    +(1.210000*x('c239')/(1.210000-x('c188'))) 
...
nl16..  
    +(1.210000*x('c234')/(1.210000-x('c192'))) 
    +(1.210000*x('c245')/(1.210000-x('c192'))) 
...
nl22..  
    ...
    -(1.210000*x('c257')/(1.210000-x('c177')))
    -x('c199') =l= 0; 
...
nl24..  
    ...
    -(1.210000*x('c257')/(1.210000-x('c178')))
    -x('c199') =l= 0; 
...
nl25..  
    ...
    +(1.210000*x('c260')/(1.210000-x('c179')))
    -x('c200') =l= 0; 
...
nl26..  
    ...
    -(1.210000*x('c262')/(1.210000-x('c179')))
...
nl27..  
    ...
    +(1.210000*x('c260')/(1.210000-x('c181')))
    -x('c200') =l= 0; 
...
nl28..  
    ...
    -(1.210000*x('c262')/(1.210000-x('c181')))
...
nl30..  
    -(1.210000*x('c265')/(1.210000-x('c186')))
    -x('c205') =l= 0; 
...
nl33..  
    ...
    +(1.210000*x('c267')/(1.210000-x('c187')))
    -x('c206') =l= 0; 

Equation  nl34;  
* Stripping section equation for [2,4] & Theta(2) 
nl34..  
    -(1.210000*x('c268')/(1.210000-x('c187')))
...
nl35..  
    ...
    +(1.210000*x('c267')/(1.210000-x('c188')))
    -x('c206') =l= 0; 

Equation  nl36;  
* Stripping section equation for [2,4] & Theta(3) 
nl36..  
    -(1.210000*x('c268')/(1.210000-x('c188')))
...
nl37..  
    ...
    +(1.210000*x('c271')/(1.210000-x('c189')))
...
nl38..  
    -(1.210000*x('c273')/(1.210000-x('c189')))
...
nl39..  
    ...
    +(1.210000*x('c271')/(1.210000-x('c191')))
...
nl40..  
    -(1.210000*x('c273')/(1.210000-x('c191')))
...
nl41..  
    +(1.210000*x('c276')/(1.210000-x('c192')))
    -x('c210') =l= 0; 
...
nl45..  
    +(1.210000*x('c278')/(1.210000-x('c193')))
...
nl47..  
    +(1.210000*x('c278')/(1.210000-x('c194')))
...
nl53..  
    ...
    +(1.210000*x('c260')/(1.210000-x('c180')))
    +x('c216')-x('c200') =e= 0; 
...
nl54..  
    ...
    -(1.210000*x('c262')/(1.210000-x('c180')))
...
nl55..  
    ...
    +(1.210000*x('c271')/(1.210000-x('c190')))
...
nl56..  
    -(1.210000*x('c273')/(1.210000-x('c190')))
...
$onecho > baron.o99
SumName   "feedcase99bar.lst"
$offecho

qp.OptFile = 99;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 18.309726976593; mvd.up = 27.464590464889; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase99_sol', x, y, mvd, returnStat, lower_bnd 
