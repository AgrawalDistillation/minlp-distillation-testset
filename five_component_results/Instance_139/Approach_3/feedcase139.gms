...
$onecho > baron.139
SumName   "feedcase139bar.lst"
$offecho

qp.OptFile = 139;
x.lo(c) = xlb(c); x.up(c) = xub(c); 
y.lo(b) = ylb(b); y.up(b) = yub(b); 
* mvd.lo = 10.241158587516; mvd.up = 15.361737881275; 
Option minlp=baron;
Option OptCr = 0.01;
Option Reslim = 18000;
...
lower_bnd = qp.objEst;
Execute_unload 'feedcase139_sol', x, y, mvd, returnStat, lower_bnd 
